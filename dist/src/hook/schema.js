...
export const ALLOWED_HANDOFF = ["clean", "interrupted"];
...
export function validateFrontmatter(frontmatter) {
    ...
    for (const key of GATE_KEYS) {
        if (key in frontmatter && !ALLOWED_GATE_VALUES.includes(frontmatter[key])) {
    ...
    if ("handoff" in frontmatter && !ALLOWED_HANDOFF.includes(frontmatter.handoff)) {
